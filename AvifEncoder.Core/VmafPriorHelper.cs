...
namespace AvifEncoder
{
    ...
    public static class VmafPriorHelper
    {
        ...
        private static readonly Dictionary<string, List<Entry>> Tables = new()
        {
            ["vmaf"] = new()
            {
                new(86, 44, 41, 51, 3.99),
                new(88, 41, 38, 48, 4.07),
                new(89, 40, 37, 47, 4.17),
            ...
            ["ssim"] = new()
            {
                new(0.980, 53, 45, 63,  6.53),
                new(0.985, 51, 42, 62,  7.37),
                new(0.988, 48, 40, 61,  7.89),
                ...
                new(0.999, 21, 10, 40, 11.00),
            },
            ["psnr"] = new()
            {
                new(38, 37, 27, 50, 8.24),
                new(40, 31, 21, 44, 8.53),
            ...
            ["msssim"] = new()
            {
                new(0.980, 48, 40, 60,  7.73),
                new(0.985, 45, 36, 58,  8.54),
                new(0.988, 42, 32, 57,  9.04),
                ...
                new(0.999,  9,  5, 25,  9.91),
            },
            ["xpsnr"] = new()
            {
                new(38, 56, 46, 63,  8.01),
                new(40, 51, 40, 62,  9.07),
            ...
            ["ssimu2"] = new()
            {
                new(60, 40, 35, 48, 6.65),
                new(65, 37, 31, 45, 6.64),
                new(68, 35, 29, 42, 6.76),
